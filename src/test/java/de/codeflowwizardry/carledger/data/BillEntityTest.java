...
public class BillEntityTest {
    ...
    void shouldCalculateEverything() {
        ...
        FuelBillInput input = new FuelBillInput(LocalDate.of(2025, 12, 9), distance, valueOf(30.58), pricePerUnit, estimate, vatRate);

        // when
        FuelBillEntity bill = FuelBillEntity.toEntity(input);
