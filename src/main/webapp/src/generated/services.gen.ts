...
import type { CallbackError, CallbackResponse, LoginError, LoginResponse, LogoutError, LogoutResponse, AddNewBillData, AddNewBillError, AddNewBillResponse, GetAllBillsData, GetAllBillsError, GetAllBillsResponse, DeleteBillData, DeleteBillError, DeleteBillResponse, GetMyCarsError, GetMyCarsResponse, CreateCarData, CreateCarError, CreateCarResponse, GetMyCarData, GetMyCarError, GetMyCarResponse, ImportCsvData, ImportCsvError, ImportCsvResponse, GetApiStatsByCarIdAverageData, GetApiStatsByCarIdAverageError, GetApiStatsByCarIdAverageResponse, GetApiStatsByCarIdHiLoData, GetApiStatsByCarIdHiLoError, GetApiStatsByCarIdHiLoResponse, GetApiStatsByCarIdTotalData, GetApiStatsByCarIdTotalError, GetApiStatsByCarIdTotalResponse, GetMyselfError, GetMyselfResponse } from './types.gen';
 ...
 * Get Average
 */
export const getApiStatsByCarIdAverage = <ThrowOnError extends boolean = false>(options: Options<GetApiStatsByCarIdAverageData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiStatsByCarIdAverageResponse, GetApiStatsByCarIdAverageError, ThrowOnError>({
        ...options,
 ...
 * Get Hi Lo
 */
export const getApiStatsByCarIdHiLo = <ThrowOnError extends boolean = false>(options: Options<GetApiStatsByCarIdHiLoData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiStatsByCarIdHiLoResponse, GetApiStatsByCarIdHiLoError, ThrowOnError>({
        ...options,
 ...
 * Get Total
 */
export const getApiStatsByCarIdTotal = <ThrowOnError extends boolean = false>(options: Options<GetApiStatsByCarIdTotalData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiStatsByCarIdTotalResponse, GetApiStatsByCarIdTotalError, ThrowOnError>({
        ...options,
