...
import {createRef, forwardRef, Fragment, useEffect, useImperativeHandle, useState} from "react";
...
export default forwardRef<BillGridRef, BillGridListProps>((props, ref) => {
    const {data, setPagination} = useBillPagination(props.carId, defaultPagination);
