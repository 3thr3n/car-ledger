	...
	return (
		<Grid2 size={2} sx={{
			...
			<Card
				...
				<CardHeader
					title={props.bill.day}
				/>
				<CardContent>
					<BillCardRow>
						<BillCardItem name={'Distance'} value={`${props.bill.distance} km`} />
						<BillCardItem name={'Costs'} value={`${props.bill.calculatedPrice} €`} />
					</BillCardRow>
					<BillCardRow>
						<BillCardItem name={'Unit'} value={`${props.bill.unit} l`} />
						<BillCardItem name={'PPU'} value={`${props.bill.pricePerUnit} ct`} />
					</BillCardRow>
					<BillCardRow>
						<BillCardItem name={'Actual'} value={`${props.bill.calculated} l/100km`} />
						<BillCardItem name={'Estimate'} value={`${props.bill.estimate} l/100km`} />
					</BillCardRow>
				</CardContent>
			</Card>
		</Grid2>
