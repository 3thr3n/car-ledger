...
export default function CsvUploadStepper(props: CsvUploadStepperProps) {
	...
	const [loadingColor, setLoadingColor] = useState<'primary' | 'error' | 'success'>('primary');
	...
	const nextStep = () => {
		setActiveStep(2);
		if (!carId) {
			toast.error('For some reason the id of car was not set, no import possible!');
			return;
		}
	...
	return (
		<Stepper orientation="vertical" activeStep={activeStep}>
			...
			<Step>
				...
				<StepContent>
					<LinearProgress color={loadingColor} variant={'determinate'} value={loading} />
