...
public class AuthResource
{
	...
	@Inject
	public AuthResource(AccountRepository accountRepository, @RestClient KeycloakTokenService keycloakTokenService,
	...
	private void checkUser(String name)
	{
		...
		Optional<Account> optionalAccount = accountRepository.findByIdentifierOptional(name);
